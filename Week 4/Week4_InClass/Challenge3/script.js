...
function show(button_element) {
    ...
    */
    ...
    //  What is its data type? (ans: element object)
    ...
    var chosenTA = button_element.id;

    var funfact = facts[chosenTA];
    var factElement = document.getElementById('ta-fun-fact');
    ...
    var photoElement = document.getElementById('ta-photo');
    photoElement.src = 'photos/' + chosenTA + '.jpg';
