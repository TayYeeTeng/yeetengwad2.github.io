...
const YOUTUBE_API_KEY = 'AIzaSyCziaij6nGz-4mlPSzYcbncenpbl3ZCGAU'; // Did you get your YouTube API key?
...
function populate_heroes(heroes){
    ...
    for(let hero of heroes){
        ...
        var getYoutube = `https://www.googleapis.com/youtube/v3/search?q=mobile legends ${heroName}&key=${YOUTUBE_API_KEY}&type=video&maxResults=1`;
        var getVideo = "";
        axios.get(getYoutube)
        .then(response => {
            getVideo = response.data.items[0].id.videoId;
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-9">
                                <div class="card-body">
                                    ...
                                    <button class='video' data-bs-toggle="modal" data-bs-target="#${heroName}Video">YouTube/Videos</button>

                                    <div class="modal" id="${heroName}Video">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">

                                            <!-- Modal Header -->
                                            <div class="modal-header">
                                                <h4 class="modal-title">${heroName} Gameplay</h4>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal">&times;</button>
                                            </div>
                                            
                                            <!-- Modal body -->
                                            <div class="modal-body mx-auto">
                                                <iframe id="iframe_1" width="560" height="315" src="https://www.youtube.com/embed/${getVideo}" frameborder="0" 
